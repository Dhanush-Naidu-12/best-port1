...
const Skills = () => {
  const text = `“Strong problem-solving, communication, and adaptability skills, with the ability to learn quickly and work effectively in collaborative or independent environments.”`
  ...
  return (
    <section id="skills" className="min-h-screen bg-black rounded-t-4xl">
      <AnimatedHeaderSection
        subTitle={"Excellence is not a skill, it’s an attitude."}
        text={text}
