...
const Hero = () => {
    ...
    const text = `I am an aspiring Electronics and Communication Engineer,
    specialized in embedded systems, 
    digital electronics and Python.`;
 
  return (
     <section id='home' className='flex flex-col justify-end min-h-screen'>
       <AnimatedHeaderSection subTitle={"404 No Bugs Found"} title={"Dhanush"} text={text} textColor={"text-black"}/>
            ...
            <Canvas shadows camera={{position:[0, 0, -10],fov:17.5, near: 1, far: 20}}>
                ...
                <Environment resolution={256}>
                    <group rotation={[-Math.PI/3, 4 , 1]}>
                        ...
                        <Lightformer form={"circle"} intensity={2} position={[0,5,1]} scale={10}/>
